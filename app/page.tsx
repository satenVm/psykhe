  ...
  return (
    <>
      ...
      <nav style={{
        ...
        <div style={{ fontFamily: "'Space Mono', monospace", fontSize: '13px', letterSpacing: '0.3em', color: '#b8a98c' }}>PSYKHE</div>
      ...
      <main style={{ background: '#080808', color: '#e8e2d5', fontFamily: "'Cormorant Garamond', Georgia, serif" }}>
        ...
        {/* HERO */}
        <section style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '8rem 3rem 4rem', position: 'relative', overflow: 'hidden' }}>
          
          {/* Background orbs */}
          <div className="orb" style={{ width: '500px', height: '500px', background: 'rgba(84,62,98,0.15)', top: '10%', right: '5%', animationDelay: '0s' }} />
          <div className="orb" style={{ width: '300px', height: '300px', background: 'rgba(40,70,100,0.1)', bottom: '20%', left: '10%', animationDelay: '3s' }} />
          <div className="orb" style={{ width: '200px', height: '200px', background: 'rgba(184,169,140,0.06)', top: '50%', right: '30%', animationDelay: '1.5s' }} />

          {/* Big Ψ background */}
          <div style={{
            position: 'absolute', right: '3rem', top: '50%', transform: 'translateY(-50%)',
            fontSize: '30vw', fontWeight: 300, color: 'rgba(232,226,213,0.02)',
          ...
          <h1 className="hero-h1" style={{ fontSize: 'clamp(4rem, 9vw, 9rem)', fontWeight: 300, lineHeight: 0.9, letterSpacing: '-0.02em' }}>
            The<br />
          ...
          <div className="hero-cta" style={{ display: 'flex', alignItems: 'center', gap: '2.5rem', marginTop: '3.5rem' }}>
            <button className="btn-primary">Begin Exploring →</button>
            <span style={{ fontFamily: "'Space Mono', monospace", fontSize: '10px', color: 'rgba(232,226,213,0.3)', letterSpacing: '0.2em' }}>
              Watch the theory
            </span>
          </div>
        ...
        <section style={{ padding: '6rem 3rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1px', background: 'rgba(232,226,213,0.06)' }}>
            {concepts.map((card, i) => (
              <div
                key={card.num}
                className="card-item"
              ...
              >
                ...
                <h3 style={{ fontSize: '1.5rem', fontWeight: 300, marginBottom: '1rem', color: hoveredCard === i ? '#e8e2d5' : 'rgba(232,226,213,0.85)', transition: 'color 0.3s' }}>
                  {card.title}
                </h3>
        ...
        {/* QUOTE */}
        <section style={{ padding: '8rem 3rem', textAlign: 'center', borderTop: '1px solid rgba(232,226,213,0.06)', borderBottom: '1px solid rgba(232,226,213,0.06)', position: 'relative', overflow: 'hidden' }}>
          ...
          <blockquote style={{ fontSize: 'clamp(1.3rem, 3vw, 2.2rem)', fontWeight: 300, fontStyle: 'italic', color: 'rgba(232,226,213,0.7)', maxWidth: '700px', margin: '0 auto', lineHeight: 1.6 }}>
        ...
        {/* NEWSLETTER */}
        <section style={{ padding: '6rem 3rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '3rem', flexWrap: 'wrap' }}>
          <h2 style={{ fontSize: 'clamp(1.8rem, 3.5vw, 3rem)', fontWeight: 300, maxWidth: '400px' }}>
            Descend deeper.<br />
            <span style={{ fontStyle: 'italic', color: 'rgba(232,226,213,0.3)' }}>Weekly dispatches</span><br />
            from the psyche.
          </h2>
          <div style={{ display: 'flex', flex: 1, maxWidth: '480px', borderBottom: '1px solid rgba(232,226,213,0.2)' }}>
            <input
              type="email"
        ...
        {/* FOOTER */}
        <footer style={{ padding: '2rem 3rem', borderTop: '1px solid rgba(232,226,213,0.06)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
